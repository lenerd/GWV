...
\begin{enumerate}
    \item
        \begin{enumerate}[label=(\alph*)]
            ...
            Der Algorithmus terminiert, sobald er eine Konfiguration erreicht, welche $\langle S, \textbf{nil}, A \rangle$ beinhaltet. Wir befinden uns nun in einem Zustand, in welchem die Eingabe zu Ende gelesen wurde. Dies bedeutet, dass der der Eingabe-String $W$ "geparsed" \ wurde, somit der der Input-Token die leere Menge \textf{nil} darstellt. Ob noch Daten auf dem Stack liegen ist unerheblich.
	        }
